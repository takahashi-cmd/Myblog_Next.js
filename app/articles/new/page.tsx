    ...
    <div className="min-h-screen py-8 px-4 md:px-12">
      ...
      <form className="bg-slate-200 p-6 rounded shadow-lg">
        <div className="mb-4">
          ...
          <input
            type="text"
            className="bg-white shadow border rounded w-full py-2 px-3 text-gray-700"
          />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <textarea className="bg-white shadow border rounded w-full py-2 px-3 text-gray-700" />
        </div>
